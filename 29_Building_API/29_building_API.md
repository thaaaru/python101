...
[<<_28](../28_API/28_API.md) | [Day 29 >>](../30_Conclusions/30_conclusions.md)
...
- [💻 Exercises:_29](#-exercises-day-29)
...
#
MONGODB_URI='mongodb+srv://Tharaka:your_password@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority'
...
We can access signle document using an id, let's access Tharaka using his id.
...
[<<_28](../28_API/28_API.md) | [Day 30 >>](../30_Conclusions/30_conclusions.md)
