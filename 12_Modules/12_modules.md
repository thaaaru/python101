...
[<<_11](../11_Functions/11_functions.md) | [Day 13>>](../13_List_comprehension/13_list_comprehension.md)
...
- [📘_12](#-day-12)
  ...
  - [💻 Exercises:_12](#-exercises-day-12)
...
# main.py file
import mymodule
print(mymodule.generate_full_name('Tharaka', 'Mahabage')) # Tharaka Mahabage
```
...
print(generate_full_name('Asabneh','Mahabage'))
...
print(fullname('Asabneh','Mahabage'))
print(total(1, 9))
mass = 100;
weight = mass * g
print(weight)
...
```sh
python script.py Tharaka 30DaysOfPython
```

The result:

```sh
Welcome Tharaka. Enjoy  30DayOfPython challenge! 
```
...
🌕 You are going far. Keep going! You have just completed_12 challenges and you are 12 steps a head in to your way to greatness. Now do some exercises for your brain and muscles.
