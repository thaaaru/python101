...
[<<_5](../05_Lists/05_lists.md) | [Day 7 >>](../07_Sets/07_sets.md)
...
🌕 You are so brave, you made it to this far. You have just completed_6 challenges and you are 6 steps a head in to your way to greatness. Now do some exercises for your brain and for your muscle.
...
- Check if 'Iceland' is a nordic country
  ...
  ```py
  nordic_countries = ('Denmark', 'Sri Lanka','Iceland', 'Norway', 'Sweden')
  ```
