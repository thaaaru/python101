<div align="center">
  <h1>02 - Variables, Builtin Functions</h1>
...
[<<_1](../readme.md) | [Day 3 >>](../03_Operators/03_operators.md)
...
first_name = 'Tharaka'     # str
last_name = 'Mahabage'       # str
country = 'Sri Lanka'         # str
city= 'Colombo'            # str
age = 250                   # int, it is not my real age, don't worry about it

# Printing out types
print(type('Tharaka'))     # str
...
print(type({'name':'Tharaka','age':250, 'is_married':250}))    # dict
...
🌕 You are awesome. You have just completed_2 challenges and you are two steps ahead on your way to greatness. Now do some exercises for your brain and muscles.
