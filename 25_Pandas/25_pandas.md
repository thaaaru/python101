...
[<<_24](../24_Statistics/24_statistics.md) | [Day 26 >>](../26_Python_web/26_python_web.md)
...
- [📘_25](#-day-25)
  ...
  - [Exercises:_25](#exercises-day-25)
...
```python
dct = {'name':'Tharaka','country':'Sri Lanka','city':'Colombo'}
```
...
```python
data = {'Name': ['Tharaka', 'David', 'John'], 'Country':[
    'Sri Lanka', 'UK', 'Sweden'], 'City': ['Helsiki', 'London', 'Stockholm']}
...
```python
data = [
    {'Name': 'Tharaka', 'Country': 'Sri Lanka', 'City': 'Colombo'},
...
```sh
curl -O https://raw.githubusercontent.com/Tharaka/30-Days-Of-Python/master/data/weight-height.csv
```
