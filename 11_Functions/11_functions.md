...
[<<_10](../10_Loops/10_loops.md) | [Day 12 >>](../12_Modules/12_modules.md)
...
- [📘_11](#-day-11)
  ...
  - [💻 Exercises:_11](#-exercises-day-11)
...
def generate_full_name (first_name, last_name):
    space = ' '
      full_name = first_name + space + last_name
      return full_name
print('Full Name: ', generate_full_name('Tharaka','Mahabage'))
...
def print_fullname(firstname, lastname):
    ...
    print(full_name)
print(print_fullname(firstname = 'Tharaka', lastname = 'Mahabage'))
...
def print_name(firstname):
    return firstname
print_name('Tharaka') # Tharaka

def print_full_name(firstname, lastname):
    space = ' '
    full_name = firstname  + space + lastname
    return full_name
print_full_name(firstname='Tharaka', lastname='Mahabage')
```
...
def generate_full_name (first_name = 'Tharaka', last_name = 'Mahabage'):
    space = ' '
    full_name = first_name + space + last_name
    return full_name
...
def generate_groups (team,*args):
    ...
    for i in args:
        print(i)
print(generate_groups('Team-1','Tharaka','Brook','David','Eyob'))
```
...
🌕 You achieved quite a lot so far.  Keep going! You have just completed_11 challenges and you are 11 steps a head in to your way to greatness. Now do some exercises for your brain and muscles.
