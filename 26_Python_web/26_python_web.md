...
[<<_25 ](../25_Pandas/25_pandas.md) | [Day 27 >>](../27_Python_with_mongodb/27_python_with_mongodb.md)
...
- [📘_26](#-day-26)
  ...
  - [Exercises:_26](#exercises-day-26)
...
```sh
Tharaka@Tharaka:~/Desktop$ mkdir python_for_web
Tharaka@Tharaka:~/Desktop$ cd python_for_web/
Tharaka@Tharaka:~/Desktop/python_for_web$ virtualenv venv
Tharaka@Tharaka:~/Desktop/python_for_web$ source venv/bin/activate
(env) Tharaka@Tharaka:~/Desktop/python_for_web$ pip freeze
(env) Tharaka@Tharaka:~/Desktop/python_for_web$ pip install Flask
(env) Tharaka@Tharaka:~/Desktop/python_for_web$ pip freeze
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) Tharaka@Tharaka:~/Desktop/python_for_web$
```
...
Logging in... done
Logged in as Tharaka@gmail.com
Tharaka@Tharaka:~$
```
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) Tharaka@Tharaka:~/Desktop/python_for_web$ touch requirements.txt
(env) Tharaka@Tharaka:~/Desktop/python_for_web$ pip freeze > requirements.txt
(env) Tharaka@Tharaka:~/Desktop/python_for_web$ cat requirements.txt
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
Jinja2==2.10.3
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) Tharaka@Tharaka:~/Desktop/python_for_web$ touch Procfile
(env) Tharaka@Tharaka:~/Desktop/python_for_web$ ls
Procfile          env/              static/
