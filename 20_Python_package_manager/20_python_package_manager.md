...
[<<_19](../19_File_handling/19_file_handling.md) | [Day 21 >>](../21_Classes_and_objects/21_classes_and_objects.md)
...
- [📘_20](#-day-20)
  ...
  - [Exercises:_20](#exercises-day-20)
...
```sh
Tharaka@Tharaka:~$ pip install pip
```
...
```sh
Tharaka@Tharaka:~$ pip install numpy
```
...
```sh
Tharaka@Tharaka:~$ pip install pandas
```
...
url_lists = [
    'http://www.python.org',
    'https://www.linkedin.com/in/Tharaka/',
    'https://github.com/Tharaka',
    'https://twitter.com/Tharaka',
]
...
```sh
Tharaka@Tharaka:~$ pip show pandas
Name: pandas
Version: 1.2.3
...
```sh
Tharaka@Tharaka:~$ pip show --verbose pandas
Name: pandas
Version: 1.2.3
Summary: Powerful data structures for data analysis, time series, and statistics
Home-page: http://pandas.pydata.org
...
```py
Tharaka@Tharaka:~$ pip install requests
```
...
```sh
Tharaka@Tharaka:~/Desktop/30DaysOfPython$ python
Python 3.9.6 (default, Jun 28 2021, 15:26:21)
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
...
>>> greet.greet_person('Tharaka', 'Mahabage')
'Tharaka Mahabage, welcome to 30DaysOfPython Challenge!'
>>>
```
