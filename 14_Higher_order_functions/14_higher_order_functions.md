<div align="center">
  <h1>014 - Higher Order Functions</h1>
...
[<<_13](../13_List_comprehension/13_list_comprehension.md) | [Day 15>>](../15_Python_type_errors/15_python_type_errors.md)
...
- [📘_14](#-day-14)
  ...
  - [💻 Exercises:_14](#-exercises-day-14)
...
print_full_name("Tharaka", "Mahabage",'Sri Lanka')
```
...
```py
names = ['Tharaka', 'Lidiya', 'Ermias', 'Abraham']  # iterable

def change_to_upper(name):
    return name.upper()

names_upper_cased = map(change_to_upper, names)
print(list(names_upper_cased))    # ['Tharaka', 'LIDIYA', 'ERMIAS', 'ABRAHAM']
...
```py
countries = ['Estonia', 'Sri Lanka', 'Sweden', 'Denmark', 'Norway', 'Iceland']
names = ['Tharaka', 'Lidiya', 'Ermias', 'Abraham']
...
1. Use reduce to concatenate all the countries and to produce this sentence: Estonia, Sri Lanka, Sweden, Denmark, Norway, and Iceland are north European countries
1. Declare a function called categorize_countries that returns a list of countries with some common pattern (you can find the [countries list](https://github.com/Tharaka/30-Days-Of-Python/blob/master/data/countries.py) in this repository as countries.js(eg 'land', 'ia', 'island', 'stan')).
...
1. Use the countries_data.py (https://github.com/Tharaka/30-Days-Of-Python/blob/master/data/countries-data.py) file and follow the tasks below:
