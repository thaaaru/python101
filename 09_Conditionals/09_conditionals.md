...
[<<_8](../08_Dictionaries/08_dictionaries.md) | [Day 10 >>](../10_Loops/10_loops.md)
...
🌕 You are doing great.Never give up because great things take time. You have just completed_9 challenges and you are 9 steps a head in to your way to greatness. Now do some exercises for your brain and muscles.
...
```
     ...
     * If the person is married and if he lives in Sri Lanka, print the information in the following format:

```py
    Tharaka Mahabage lives in Sri Lanka. He is married.
```
