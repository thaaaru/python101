...
[<<_4](../04_Strings/04_strings.md) | [Day 6 >>](../06_Tuples/06_tuples.md)
...
countries = ['Sri Lanka', 'Estonia', 'Denmark', 'Sweden', 'Norway']
...
```py
 lst = ['Tharaka', 250, True, {'country':'Sri Lanka', 'city':'Colombo'}] # list containing different data types
```
...
countries = ['Germany', 'France','Belgium','Sweden','Denmark','Sri Lanka','Norway','Iceland','Estonia']
...
🌕 You are diligent and you have already achieved quite a lot. You have just completed_5 challenges and you are 5 steps a head in to your way to greatness. Now do some exercises for your brain and muscles.
...
1. Find the middle country(ies) in the [countries list](https://github.com/Tharaka/30-Days-Of-Python/tree/master/data/countries.py)
1. Divide the countries list into two equal lists if it is even if not one more country for the first half.
1. ['China', 'Russia', 'USA', 'Sri Lanka', 'Sweden', 'Norway', 'Denmark']. Unpack the first three countries and the rest as scandic countries.
