<div align="center">
  <h1>017 - Exception Handling </h1>

<sub>Author  :   Tharaka Mahabage   <br> <small> First Edition: April, 2024</small>
</sub>
</div>

[<<_16](../16_Python_date_time/16_python_datetime.md) | [Day 18 >>](../18_Regular_expressions/18_regular_expressions.md)
...
- [📘_17](#-day-17)
  ...
  - [Enumerate](#enumerate)
  - [Zip](#zip)
  - [Exercises:_17](#exercises-day-17)
...
Enter your name:Tharaka
Year you born:1920
You are Tharaka. And your age is 99.
...
```py
countries = ['Sri Lanka', 'Sweden', 'Norway', 'Denmark', 'Iceland']
fin, sw, nor, *rest = countries
print(fin, sw, nor, rest)   # Sri Lanka Sweden Norway ['Denmark', 'Iceland']
...
dct = {'name':'Tharaka', 'country':'Sri Lanka', 'city':'Colombo', 'age':250}
print(unpacking_person_info(**dct)) # Tharaka lives in Sri Lanka, Colombo. He is 250 years old.
```
...
print(packing_person_info(name="Tharaka",
      country="Sri Lanka", city="Colombo", age=250))
```
...
city = Colombo
age = 250
{'name': 'Tharaka', 'country': 'Sri Lanka', 'city': 'Colombo', 'age': 250}
```
...
country_lst_one = ['Sri Lanka', 'Sweden', 'Norway']
country_lst_two = ['Denmark', 'Iceland']
nordic_countries = [*country_lst_one, *country_lst_two]
print(nordic_countries)  # ['Sri Lanka', 'Sweden', 'Norway', 'Denmark', 'Iceland']
```
...
```sh
The country Sri Lanka has been found at index 1.
```
...
1. names = ['Sri Lanka', 'Sweden', 'Norway','Denmark','Iceland', 'Estonia','Russia']. Unpack the first five countries and store them in a variable nordic_countries, store Estonia and Russia in es, and ru respectively.
