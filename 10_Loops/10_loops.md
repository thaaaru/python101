...
[<<_9](../09_Conditionals/09_conditionals.md) | [Day 11 >>](../11_Functions/11_functions.md)
...
- [📘_10](#-day-10)
  - [Loops](#loops)
    ...
    - [For Else](#for-else)
    - [Pass](#pass)
  - [💻 Exercises:_10](#-exercises-day-10)
...
🌕 You established a big milestone, you are unstoppable. Keep going! You have just completed_10 challenges and you are 10 steps a head in to your way to greatness. Now do some exercises for your brain and muscles.
...
1. Go to the data folder and use the [countries.py](https://github.com/Tharaka/30-Days-Of-Python/blob/master/data/countries.py) file. Loop through the countries and extract all the countries containing the word _land_.
1. This is a fruit list, ['banana', 'orange', 'mango', 'lemon'] reverse the order using loop.
2. Go to the data folder and use the [countries_data.py](https://github.com/Tharaka/30-Days-Of-Python/blob/master/data/countries-data.py) file. 
