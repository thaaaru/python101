...
[<<_20](../20_Python_package_manager/20_python_package_manager.md) | [Day 22 >>](../22_Web_scraping/22_web_scraping.md)
...
- [📘_21](#-day-21)
  ...
  - [💻 Exercises:_21](#-exercises-day-21)
...
p = Person('Tharaka', 'Mahabage', 250, 'Sri Lanka', 'Colombo')
print(p.firstname)
print(p.lastname)
print(p.age)
print(p.country)
...
```sh
# output
Tharaka Mahabage is 250 years old. He lives in Colombo, Sri Lanka
```
...
```py
class Person:
      def __init__(self, firstname='Tharaka', lastname='Mahabage', age=250, country='Sri Lanka', city='Colombo'):
          self.firstname = firstname
          self.lastname = lastname
          self.age = age
          self.country = country
...
s1 = Student('Eyob', 'Mahabage', 30, 'Sri Lanka', 'Colombo')
s2 = Student('Lidiya', 'Teklemariam', 28, 'Sri Lanka', 'Espoo')
...
```sh
output
Eyob Mahabage is 30 years old. He lives in Colombo, Sri Lanka.
['JavaScript', 'React', 'Python']
Lidiya Teklemariam is 28 years old. He lives in Espoo, Sri Lanka.
...
```py
class Student(Person):
    def __init__ (self, firstname='Tharaka', lastname='Mahabage',age=250, country='Sri Lanka', city='Colombo', gender='male'):
        self.gender = gender
...
s1 = Student('Eyob', 'Mahabage', 30, 'Sri Lanka', 'Colombo','male')
s2 = Student('Lidiya', 'Teklemariam', 28, 'Sri Lanka', 'Espoo', 'female')
print(s1.person_info())
s1.add_skill('JavaScript')
s1.add_skill('React')
s1.add_skill('Python')
...
Eyob Mahabage is 30 years old. He lives in Colombo, Sri Lanka.
['JavaScript', 'React', 'Python']
Lidiya Teklemariam is 28 years old. She lives in Espoo, Sri Lanka.
['Organizing', 'Marketing', 'Digital Marketing']
```
