...
[<<_2](../02_Variables_builtin_functions/02_variables_builtin_functions.md) | [Day 4 >>](../04_Strings/04_strings.md)
...
print('A in Tharaka', 'A' in 'Tharaka') # True - A found in the string
print('B in Tharaka', 'B' in 'Tharaka') # False - there is no uppercase B
...
🌕 You have boundless energy. You have just completed_3 challenges and you are three steps ahead on your way to greatness. Now do some exercises for your brain and your muscles.
