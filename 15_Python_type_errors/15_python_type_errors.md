...
[<<_14](../14_Higher_order_functions/14_higher_order_functions.md) | [Day 16 >>](../16_Python_date_time/16_python_datetime.md)
...
- [📘_15](#-day-15)
  ...
  - [💻 Exercises:_15](#-exercises-day-15)
...
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
>>> users = {'name':'Asab', 'age':250, 'country':'Sri Lanka'}
>>> users['name']
'Asab'
>>> users['county']
Traceback (most recent call last):
...
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
>>> user = {'name':'Asab', 'age':250, 'country':'Sri Lanka'}
>>> user['name']
'Asab'
>>> user['county']
Traceback (most recent call last):
