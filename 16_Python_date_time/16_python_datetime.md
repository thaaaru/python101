...
[<<_15](../15_Python_type_errors/15_python_type_errors.ipynb) | [Day 17 >>](../17_Exception_handling/17_exception_handling.ipynb)
...
- [📘_16](#-day-16)
  ...
  - [💻 Exercises:_16](#-exercises-day-16)
# 📘_16
...
t1 = datetime(year = 2019, month = 12,_= 5, hour = 0, minute = 59, second = 0)
t2 = datetime(year = 2020, month = 1,_= 1, hour = 0, minute = 0, second = 0)
diff = t2 - t1
