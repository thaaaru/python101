...
[<<_12](../12_Modules/12_modules.md) | [Day 14>>](../14_Higher_order_functions/14_higher_order_functions.md)
...
- [📘_13](#-day-13)
  ...
  - [💻 Exercises:_13](#-exercises-day-13)
...
🌕 Keep up the good work. Keep the momentum going, the sky is the limit! You have just completed_13 challenges and you are 13 steps a head in to your way to greatness. Now do some exercises for your brain and muscles.
...
4. Flatten the following list to a new list:
   ```py
   countries = [[('Sri Lanka', 'Colombo')], [('Sweden', 'Stockholm')], [('Norway', 'Oslo')]]
   output:
   [['Sri Lanka','FIN', 'Colombo'], ['SWEDEN', 'SWE', 'STOCKHOLM'], ['NORWAY', 'NOR', 'OSLO']]
   ```
...
6. Change the following list of lists to a list of concatenated strings:
   ```py
   names = [[('Tharaka', 'Mahabage')], [('David', 'Smith')], [('Donald', 'Trump')], [('Bill', 'Gates')]]
   output
   ['Tharaka Yetaeyeh', 'David Smith', 'Donald Trump', 'Bill Gates']
   ```
