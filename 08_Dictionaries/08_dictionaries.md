...
[<<_7 ](../07_Sets/07_sets.md) | [Day 9 >>](../09_Conditionals/09_conditionals.md)
...
print(person['first_name']) # Tharaka
print(person['country'])    # Sri Lanka
...
print(person.get('first_name')) # Tharaka
...
🌕 You are astonishing. Now, you are super charged with the power of dictionaries. You have just completed_8 challenges and you are 8 steps a head in to your way to greatness. Now do some exercises for your brain and  muscles.
